...
<div class="content-header">
    <div class="container-fluid">
      <div class="mb-2 row">
        <div class="col-sm-6">
          <h1 class="m-0">Créer une configuration des sites</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Accueil</a></li>
            <li class="breadcrumb-item active">Configuration des sites</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- form start -->
                        <form method="POST" id="fd_form" action={{ route('config_site.store') }} }}>
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6" id="label">
                                        <label for="label">Intitutlé du site<span class="text-danger" >*</span></label>
                                    ...
                                    {{-- <div class="form-group col-md-6" id="code">
                                        ...
                                        is-invalid
                                        @enderror" name="code" value="{{ @old('code') }}" placeholder="code du site">
                                        @error('code')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    </div> --}}

                                    <div class="form-group col-md-6" id="localisation">
                                        <label for="localisation">Paramètres de localisation</label>
                                        <input type="text" class="form-control @error('numero_compte')
                                        is-invalid
                                        @enderror" name="localisation" value="{{ @old('localisation') }}" disabled placeholder="saisir ici!">
                                        @error('localisation')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
