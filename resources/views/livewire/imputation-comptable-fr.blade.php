<div>
    <form action="{{ route('add.num_comptable_fr', $recipe_sheet->id) }}" method="POST">
        @csrf
            ...
            <div class="form-body">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        <label for="section_analytique_input">Section analytique </label>
                        {{-- <input type="text" id="section_analytique_input" value="{{ $recipe_sheet->num_dossier }}" class="form-control  @error('section_analytique') is-invalid @enderror" placeholder="Section analytique" required disabled> --}}
                        <input type="text" name="section_analytique" wire:model="imputation_comptable.section_analytique" id="section_analytique" value="{{ @old('section_analytique') }}" class="form-control  @error('section_analytique') is-invalid @enderror" placeholder="12 Digits max" >
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        <label for="montant_a_payer_input">Montant recette</label>
                        <input type="text" id="montant_a_payer_input" value="{{ \App\Helpers\MoneyHelper::price($recipe_sheet->montant) }}" class="form-control  @error('montant_a_payer_input') is-invalid @enderror" disabled>
                        <input type="number" id="montant_a_payer_input" value="{{ \App\Helpers\MoneyHelper::price($recipe_sheet->montant) }}" class="form-control  @error('montant_a_payer_input') is-invalid @enderror d-none">
