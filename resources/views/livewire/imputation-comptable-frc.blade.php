<div>
    <form action="{{ route('add.num_comptable_frc', $fiche_retour_caisse->id) }}" method="POST">
        @csrf
            ...
            <div class="form-body">
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" id="section_analytique_input" value="{{ $fiche_retour_caisse->num_dossier }}" class="form-control  @error('section_analytique') is-invalid @enderror" placeholder="Section analytique" required disabled>
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" id="montant_a_payer_input" value="{{ \App\Helpers\MoneyHelper::price($fiche_retour_caisse->montant) }}" class="form-control  @error('montant_a_payer_input') is-invalid @enderror" disabled>
                        <input type="number" id="montant_a_payer_input" value="{{ \App\Helpers\MoneyHelper::price($fiche_retour_caisse->montant) }}" class="form-control  @error('montant_a_payer_input') is-invalid @enderror d-none">
