            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        @enderror
                        {{-- @if($success['num_compte_general'])
                            <span class="valid-feedback" role="alert">
                                <strong>Format de saisie correct</strong>
                            </span>
                        @else
                            <span class="invalid-feedback" role="alert">
                                <strong>Format de saisie incorrect</strong>
                            </span>
                        @endif --}}
                    </div>
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" id="section_analytique_input" value="{{ $fiche_depense->num_dossier }}" class="form-control  @error('section_analytique') is-invalid @enderror" placeholder="Section analytique" required disabled>
                ...
                <div class="row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" id="montant_a_payer_input" value="{{ \App\Helpers\MoneyHelper::price($fiche_depense->montant) }}" class="form-control  @error('montant_a_payer_input') is-invalid @enderror" disabled>
                        <input type="number" id="montant_a_payer_input" value="{{ \App\Helpers\MoneyHelper::price($fiche_depense->montant) }}" class="form-control  @error('montant_a_payer_input') is-invalid @enderror d-none">
